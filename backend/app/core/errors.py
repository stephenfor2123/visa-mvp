...
class ErrorCode(str, Enum):
    ...
    AGE_CONFIRMATION_REQUIRED = "2016"
    CONSENT_REQUIRED = "2017"
    PROCESSING_RESTRICTED = "2018"
    ...
    PAYMENT_SIGNATURE_INVALID = "4015"
...
_ERROR_HTTP_STATUS: dict[ErrorCode, int] = {
    ...
    ErrorCode.AGE_CONFIRMATION_REQUIRED: status.HTTP_422_UNPROCESSABLE_ENTITY,
    ErrorCode.CONSENT_REQUIRED: status.HTTP_403_FORBIDDEN,
    ErrorCode.PROCESSING_RESTRICTED: status.HTTP_403_FORBIDDEN,
    ...
    ErrorCode.PAYMENT_SIGNATURE_INVALID: status.HTTP_400_BAD_REQUEST,
    # Materials domain
