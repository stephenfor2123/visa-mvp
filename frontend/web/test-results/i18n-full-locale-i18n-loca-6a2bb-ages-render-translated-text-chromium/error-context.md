...
- Name: i18n-full-locale.spec.js >> i18n locale=vi-VN auth-pages render translated text
...
- Thông tin cơ bản
+
+     VTrợ lý Visa中文ENIDVI👋 i18n🇺🇸— · Du lịch← Quay lại Hồ sơ•Cơ bản•Chuyến đi•Khẩn cấp Đang tải...
+     
+   
+
...
- main:
  - text: 🇺🇸
  - heading "— · Du lịch" [level=1]
  - button "← Quay lại Hồ sơ"
  - tablist:
    - tab "• Cơ bản" [selected]
    - tab "• Chuyến đi"
    - tab "• Khẩn cấp"
