...
- Name: flows/09-flow.spec.js >> S5.4 /orders/new 流程 (3-tab 提交) >> D22: 切到 Travel → destination 字段 select 渲染 + 默认选 US (auto-fill)
- Location: tests/e2e/flows/09-flow.spec.js:348:3
