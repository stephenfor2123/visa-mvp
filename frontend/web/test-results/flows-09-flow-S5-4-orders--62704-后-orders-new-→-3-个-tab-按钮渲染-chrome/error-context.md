...
- Name: flows/09-flow.spec.js >> S5.4 /orders/new 流程 (3-tab 提交) >> D18: 登录后 /orders/new → 3 个 tab 按钮渲染
- Location: tests/e2e/flows/09-flow.spec.js:283:3
...
Locator: getByTestId('ordernew-tab-basic')
Expected: visible
Timeout: 5000ms
