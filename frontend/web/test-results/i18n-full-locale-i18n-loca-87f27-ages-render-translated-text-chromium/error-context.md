...
- Name: i18n-full-locale.spec.js >> i18n locale=en auth-pages render translated text
...
- Basic Information
+
+     VVisa Helper中文ENIDVI👋 i18n🇺🇸— · Tourism← Back to Materials•Basic•Travel•Emergency Loading...
+     
+   
+
...
- main:
  - text: 🇺🇸
  - heading "— · Tourism" [level=1]
  - button "← Back to Materials"
  - tablist:
    - tab "• Basic" [selected]
    - tab "• Travel"
    - tab "• Emergency"
