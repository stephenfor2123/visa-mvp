...
- Name: flows/09-flow.spec.js >> S5.4 /orders/new 流程 (3-tab 提交) >> D20: 点 Basic tab → 验证 surname 字段 (surname/given_name/sex/dob/nationality/passport_no 必填)
- Location: tests/e2e/flows/09-flow.spec.js:310:3
