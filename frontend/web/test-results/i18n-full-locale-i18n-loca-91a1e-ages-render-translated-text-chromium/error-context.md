...
- Name: i18n-full-locale.spec.js >> i18n locale=id-ID auth-pages render translated text
...
- Informasi Dasar
+
+     VAsisten Visa中文ENIDVI👋 i18n🇺🇸— · Wisata← Kembali ke Dokumen•Dasar•Perjalanan•Darurat Memuat...
+     
+   
+
...
- main:
  - text: 🇺🇸
  - heading "— · Wisata" [level=1]
  - button "← Kembali ke Dokumen"
  - tablist:
    - tab "• Dasar" [selected]
    - tab "• Perjalanan"
    - tab "• Darurat"
